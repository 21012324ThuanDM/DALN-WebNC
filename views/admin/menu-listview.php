...
function print_option($sql4, $conn)
{
...
<form method="post" id="frm" name="form">
  <table width="735" height="70" border="0" cellspacing="0" cellpadding="0" bgcolor="#fbfbfb" bordercolordark="#FFFFFF">
    <tr>
      <td style="border-top:1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; border-left:1px solid #CCCCCC">
        <div align="left"
          style="color:#0B55C4; font-family:Tahoma; font-size: 16px; font-weight:bold; padding-left:20px">QUẢN LÝ SẢN
          PHẨM
        </div>
      </td>
      <td style="border-top:1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; height:65px; width:55px">
        <input type="button" value=''
          onClick="document.form.action='../admincp/?m=sp&b=sp-insert'; document.form.submit();"
      ...
      <td
        ...
        <input type="button" value=''
          onClick="document.form.action='../admincp/?m=sp&b=sp-xl-del';document.form.submit();"
  ...
  <table width="735" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php
    $kq = mysqli_query($conn, "select count(*) from sanpham,menu where sanpham.id_menu=menu.id_menu and sanpham.id_menu=$idm");
        ...
        while ($r2 = mysqli_fetch_array($kq2)) {
          ...
          <tr>
            <td width="50" align="center"
              ...
              <input type="checkbox" name="chon[]" value="<?php echo $id; ?>" />
            </td>
