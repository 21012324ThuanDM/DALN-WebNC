...
<?php 
include "connect.php";
$sql=mysqli_query($conn, "select * from nhomsanpham");
while($r=mysqli_fetch_array($sql))
{
    $tennhom=$r["tennhom"];
    $id_nhom=$r["id_nhom"];

    echo "stBM(260,\"basic1\",[0,\"\",\"\",\"blank.gif\",0,\"left\",\"default\",\"hand\",0,0,-1,-1,-1,\"none\",0,\"#CCCCCC\",\"transparent\",\"\",\"repeat\",1,\"expand_f.gif\",\"expand_uf.gif\",9,9,1,\"line_def0.gif\",\"line_def1.gif\",\"line_def2.gif\",\"line_def3.gif\",1,0,3,1,\"center\",0,0,0,\"\",\"\",\"\",\"\",\"\"]);
    ...
    $query=mysqli_query($conn, "select * from loaisanpham where id_nhom=$id_nhom");
    while($r2=mysqli_fetch_array($query))
    {
        $tenloai=$r2["tenloaisp"];
        $id_loai=$r2["id_loai"];

        echo "stIT(\"p1i0\",[\"$tenloai\",\"/admin/?m=sp&b=sp-listview&idl=$id_loai\",,,,\"file_c.gif\",\"file_c.gif\",,,\"9pt 'Verdana','Arial'\",,,,,,,\"#666666\",,,,\"no-repeat\",\"9pt 'Verdana'\",\"#000000\",,,,,,\"#666666\"],\"p0i0\");";
    }
    echo "stES(); stES(); stEM();";
}
?>
...
<?php 
include "connect.php";
$sql3=mysqli_query($conn, "select * from menu");
