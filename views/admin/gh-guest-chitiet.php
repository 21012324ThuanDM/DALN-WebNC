<table width="735" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr height="30" bgcolor="#FFCC99">
    <td align="center" width="150" style="border-left:1px solid #333; border-right:1px solid #333"><strong>Ngày
        đặt</strong></td>
  ...
  while ($r = mysqli_fetch_array($kq)) {
    ...
    <tr height="30">
      ...
      <td align="center" width="140" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong><a
            onmouseover="Tip('<?php echo "Họ tên: $users<hr>Địa chỉ: $diachi<hr>Email: $email<hr>Điện thoại: $dt"; ?>')">
            <?php echo "$users"; ?>
          </a></strong></td>
