<table width="735" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php
  $kq2 = mysqli_query($connection, "select count(*) from giohang,sanpham,thanhvien where thanhvien.user=giohang.user AND giohang.id=sanpham.id and giohang.tinhtrang='damua'");
  ...
  if (!$kq3)
    ...
    while ($r3 = mysqli_fetch_array($kq3)) {
      ...
      $tensp3 = $r3["tensp"];
      $gia3 = $r3["gia"];
      $gia32 = number_format($gia3, 0, '', '.');
      $soluong3 = $r3["soluongban"];
      $hinh3 = $r3["hinh"];
      $tong = $gia3 * $soluong3;
      ...
      <tr height="30">
        <td align="center" width="285"
          style="border-right:1px solid #333; border-bottom:1px solid #333; border-left:1px solid #333"><strong>
            <?php echo "$tensp3"; ?>
          </strong></td>
        <td align="center" width="150" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong>
            <?php echo "$gia32 VND"; ?>
          </strong></td>
        <td align="center" width="150" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong>
            <?php echo "$soluong3"; ?>
          </strong></td>
        <td align="center" width="150" style="border-right:1px solid #333; border-bottom:1px solid #333;"><img
            src="/sanpham/small/<?php echo "$hinh3"; ?>" width="90" height="90"></td>
        <td align="center" width="150" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong>
            <?php echo "$tong2 VND"; ?>
          </strong></td>
      </tr>
  ...
  <tr>
    <td align="right" colspan="5" height="30"
      style="border-bottom:1px solid #333; border-left:1px solid #333; border-right:1px solid #333; padding-right:10px">
      <strong>Tổng doanh thu:
        <?php echo "$tongtien2 VND"; ?>
      </strong>
    </td>
  </tr>
  <tr>
