...
<table width="735" border="0" cellspacing="0" cellpadding="0">
	<form method="post">
		...
		<tr height="30" bgcolor="#FFCC99">
			...
			<td align="center" width="150" style="border-right:1px solid #333; background-color: rgb(41, 198, 255)"><strong>Giá</strong></td>
		</tr>
		<?php
		$kq2 = mysqli_query($conn, "select count(*) from giohang,sanpham where giohang.id=sanpham.id and giohang.tinhtrang='dathang'");
			...
			while ($r = mysqli_fetch_array($kq)) {
				...
				<tr height="30">
					<td align="center" width="50"
						style="border-left:1px solid #333;border-right:1px solid #333;border-bottom:1px solid #333;"><strong>
						...
						<tr>
							<td align="center">
								...
								<input type="submit" name="xoa" value="Xóa" class="button"
									onmouseover="style.background='url(../images/button-2-o.gif)'"
									onmouseout="style.background='url(../images/button-o.gif)'" onclick="return check()">
							</td>
