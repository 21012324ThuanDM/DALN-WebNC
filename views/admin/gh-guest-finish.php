<?php
$query = mysqli_query($conn, "SELECT sanpham.*, hoadon.* FROM hoadon, sanpham WHERE hoadon.id = sanpham.id");
...
<table width="735" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr height="30" bgcolor="#FFCC99">
    ...
    <td align="center" width="70" style="border-right:1px solid #333; background-color: rgb(41, 198, 255)">Chi tiết</td>
  </tr>
  <?php
  $kq2 = mysqli_query($conn, "select count(*) from hoadon where tinhtrang='damua'");
  ...
  if (!$kq3)
    ...
    while ($r3 = mysqli_fetch_array($kq3)) {
      $ngaydat = $r3["ngaydat"];
      $day = ConvertDate_time_db($ngaydat);
      $user3 = $r3["hoten"];
      ...
      <tr height="30">
        <td align="center" width="200"
          style="border-bottom:1px solid #333; border-left:1px solid #333;border-right:1px solid #333;"><strong>
            <?php echo "$day"; ?>
          </strong></td>
        <td align="center" width="200" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong>
            <?php echo "$user3"; ?>
          </strong></td>
        <td align="center" width="265" style="border-right:1px solid #333; border-bottom:1px solid #333;"><strong>
            <?php echo "$tt3 VND"; ?>
          </strong></td>
        <td align="center" width="70" style="border-right:1px solid #333; border-bottom:1px solid #333;"><a
            href="?m=dh&b=gh-guest-chitiet&u=<?php echo "$user3"; ?>&ngay=<?php echo "$ngaydat"; ?>">Xem</a></td>
      </tr>
      <?php
    }
  }
