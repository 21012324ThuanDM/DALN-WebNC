...
if ($result) {
  ...
  echo "<script>alert('Có lỗi SQL khi truy vấn thông tin thành viên!');</script>";
  // Xử lý lỗi khác nếu cần
}
?>
<div align="center">
  <form method="post" onSubmit="return thanhvien_change(hoten.value,email.value,diachi.value,anti.value);"
    id="formthanhvien" name="formthanhvien">
    <table width="800" cellspacing="0" cellpadding="0" bordercolordark="#FFFFFF" style="border:1px solid #CCC;">
      <tr>
        <td height="35" colspan="2" align="center" class="tieude">
          <div align="center">
            <font color="#FFFFFF">THAY ĐỔI THÔNG TIN CÁ NHÂN -
              <?php echo "$user"; ?>
            </font>
          </div>
        </td>
      ...
      <tr bgcolor="#f9f9f9" onmouseover="style.background='#d4340c'" onmouseout="style.background='#F9F9F9'">
        <td height="50" style="padding-left:70px">
      ...
      <tr bgcolor="#f9f9f9" onmouseover="style.background='#d4340c'" onmouseout="style.background='#F9F9F9'">
        ...
        <td width="405" style="padding-left:15px">
          <div align="left">
            <input type="text" name="dienthoai" style="width:220px" value="<?php echo "$dienthoai"; ?>"
