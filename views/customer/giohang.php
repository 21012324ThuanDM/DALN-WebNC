...
if ($act == "d")
	xoaGH($id);
if ($act == "tt")
	dathang($gh, $hoten, $diachi, $email, $dt, $now);
hienthiGH($gh);
...
function hienthiGH($gh)
{
	...
	echo "<table width=1200 border=0 cellspacing=0 cellpadding=0 style=\"border:1px solid #333\">
<tr>
  ...
  <tr bgcolor=\"#ad2200\" align=center height=30 style=\"color:white \">
    <td width=\"160\" style=\"border-right:1px solid #666\"><b>Sản phẩm</b></td>
    <td width=\"120\" style=\"border-right:1px solid #666\"><b>Số lượng</td>
    <td width=\"170\" style=\"border-right:1px solid #666\"><b>Giá</td>
    <td width=\"170\" style=\"border-right:1px solid #666\"><b>Tổng</td>
	<td width=\"100\" style=\"border-right:1px solid #666\"><b>Cập Nhật</td>	
    <td width=\"100\" ><b>Xóa</td>                
  </tr>";
	$tongtien = 0;
	foreach ($gh as $id => $sl) {
		$count = count($gh);
	...
	<input type=\"button\" name=\"dathang\" value=\"Đặt Hàng\" class=\"button2\" onmouseover=\"style.background='url(../../assets/customer/images/button-110-2-o.png)'\" onmouseout=\"style.background='url(../../assets/customer/images/button-110-o.png)'\" onclick=\"document.getElementById('thanhtoan').style.display='block'\"/>
	</form>
    </td>
  </tr>";
	}
	...
	<form id='k$id'>
		<table width=\"1200\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" style=\"padding-top:10px; border:1px solid #333\">		
      ...
      <tr>
		...
		<input type=\"button\" value=\"Gửi\" class=\"button\" onmouseover=\"style.background='url(../../assets/customer/../../assets/customer/images/button-2-o.gif)'\" onmouseout=\"style.background='url(../../assets/customer/images/button-o.gif)'\" onclick=\"subMitF('k$id', 'tt');\">
          <input type=\"reset\" value=\"Nhập lại\" class=\"button\" onmouseover=\"style.background='url(../../assets/customer/images/button-2-o.gif)'\" onmouseout=\"style.background='url(../../assets/customer/images/button-o.gif)'\"  >
         </td>
      </tr>	  
    </table>
	</form>
...
function dathang($gh, $hoten, $diachi, $email, $dt, $now)
{
	...
	if ($hoten == "" || $diachi == "" || $email == "" || $dt == "") {
		...
		foreach ($gh as $id => $sl) {
			$q = $conn->query("SELECT gia FROM sanpham WHERE id='$id'");
			while ($rq = $q->fetch_array()) {
				$gia = $rq["gia"];
				$tien = $gia * $sl;
				$sql2 = "INSERT INTO hoadon(hoten,diachi,email,dienthoai,id,soluong,tongtien,ngaydat,tinhtrang) VALUES ('$hoten','$diachi','$email','$dt','$id',$sl,'$tien','$now','dathang')";
				$sql2 .= ';';
